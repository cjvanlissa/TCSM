...
```{block,type='rmdinfo'}
Before we start the course, we have to install **R**, a free program for statistical programming, and **RStudio**.
RStudio is just a user interface which makes it easier to work with R; overlook our data, packages and output. 
...
If you have **never used R before, we would like to consider this Chapter essential**, as it gives you some input on how R works, and how we can use it for our data analyses.
```
...
In order to get the most out of this guide, it's helpful (but not essential) if you have some programming experience already. If you’ve never programmed before, you might find ***Hands-On Programming with R*** [@grolemund2014hands] to be a useful primer. Andy Field is also available for R.

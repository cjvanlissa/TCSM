...
Perform a simple regression with LifeSat as the dependent variable and educ as the independent variable.
...
Perform a multiple regression with LifeSat as the dependent variable and educ, age and ChildSup as the independent variables. 
